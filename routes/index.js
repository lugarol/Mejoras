...
router.post('/quizzes/:quizId(\\d+)/tips',		sessionController.loginRequired,
 ...
 * ---------------------------------------------
 */
router.put('/users/:userId(\\d+)/favourites/:quizId(\\d+)',		sessionController.loginRequired,
    															sessionController.adminOrMyselfRequired,
    															favouriteController.add);

router.delete('/users/:userId(\\d+)/favourites/:quizId(\\d+)',	sessionController.loginRequired,
    															sessionController.adminOrMyselfRequired,
